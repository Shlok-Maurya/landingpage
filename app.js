...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (scrollyPin) {
    ...
    scrollyTL.to('#scrolly-highlights', { opacity: 1, duration: 4, ease: 'power2.out' }, 50);
    ...
    scrollyTL.to('#scrolly-highlights', { opacity: 0, duration: 3, ease: 'power2.in' }, 56);
